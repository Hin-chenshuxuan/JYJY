...
public class UserController {
     ...
     * 根据前端传递的code查询openid
     */
    @ApiOperation(value = "openid查询",notes = "通过code获取openid",tags = {"UserController"})
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path", name = "code", value = "小程序获取的code值", required = true, dataType = "String"),
    })
    @GetMapping(value = "/login/{code}")
    public Result<Map<String,String>> getOpenid(@PathVariable String code){
        Map<String,String> result = userService.getOpenid(code);
        return new Result<Map<String,String>>(true,StatusCode.OK,"查询Openid成功！",result);
    }
     ...
     * @return
     */
    @ApiOperation(value = "查询所有User",notes = "查询所有User方法详情",tags = {"UserController"})
    @GetMapping
